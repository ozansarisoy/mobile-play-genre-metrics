...
than a repeat of the Google Play or Apple signals above.
        ...
        "ai_sim_header": "AI Analysis Simulation",
        "ai_sim_disclaimer": "This is a rule-based simulation, not a live AI model call — every number comes directly from the real dataset and the same statistical tests used elsewhere in this app. Labeled as a simulation on purpose, so it never overstates what it is.",
        "ai_sim_generating": "Generating analysis...",
        "ai_sim_export_header": "Export this report",
        "ai_sim_download_excel": "📊 Download as Excel",
        "ai_sim_download_pdf": "📄 Download as PDF",
        "ai_sim_current_lang": "In the current interface language:",
        "ai_sim_other_lang": "Also available in the other language:",
        "ai_sim_font_warning": "⚠️ The bundled Unicode font for the PDF could not be loaded on this server — the PDF was generated with a fallback font that may not render Turkish characters (ş, ı, ğ, ü, ö, ç) correctly. This does not affect the Excel export. Please report this if you see it.",
        "search_header": "Find a Game",
        "search_placeholder": "Type a game name...",
        "search_no_match": "No game found matching that name.",
        "search_too_short": "Type at least 2 characters to search — a single letter matches too many games to be useful.",
...
kontrol noktasıdır.
        ...
        "ai_sim_header": "AI Analiz Simülasyonu",
        "ai_sim_disclaimer": "Bu, canlı bir yapay zeka modeli çağrısı değil, kural-tabanlı bir simülasyondur — her sayı doğrudan gerçek veri setinden ve bu uygulamada başka yerlerde de kullanılan aynı istatistiksel testlerden gelir. Ne olduğunu abartmaması için bilinçli olarak 'simülasyon' diye etiketlenmiştir.",
        "ai_sim_generating": "Analiz üretiliyor...",
        "ai_sim_export_header": "Bu raporu dışa aktar",
        "ai_sim_download_excel": "📊 Excel olarak indir",
        "ai_sim_download_pdf": "📄 PDF olarak indir",
        "ai_sim_current_lang": "Mevcut arayüz dilinde:",
        "ai_sim_other_lang": "Diğer dilde de mevcuttur:",
        "ai_sim_font_warning": "⚠️ PDF için gerekli Unicode font bu sunucuda yüklenemedi — PDF, Türkçe karakterleri (ş, ı, ğ, ü, ö, ç) doğru göstermeyebilecek yedek bir fontla üretildi. Bu durum Excel dosyasını etkilemez. Bunu görürsen lütfen bildir.",
        "search_header": "Oyun Bul",
        "search_placeholder": "Oyun adı yaz...",
        "search_no_match": "Bu isimle eşleşen oyun bulunamadı.",
        "search_too_short": "Aramak için en az 2 karakter yaz — tek harf çok fazla oyunla eşleşir, faydalı olmaz.",
